import type { AgentInfo, AgentDiagnostic, AgentFixIntent, AgentCliEnvPrefs, AgentCliEnvIntentPrefs, AgentModelPrefs, AgentTestRequest, AppRuntimeCapabilities, AppVersionInfo, AppVersionResponse, WhatsNewContent, WhatsNewLocaleContent, WhatsNewResponse, AudioKind, ChatAttachment, ChatCommentAttachment, ChatCommentSelectionKind, ChatMessageFeedback, ChatMessageFeedbackRating, ChatMessageFeedbackReasonCode, ChatMessage, ConnectionTestKind, ConnectionTestProtocol, ConnectionTestRequest, ConnectionTestResponse, Conversation, DeployConfigResponse, DeployProjectFileResponse, DesignSystemDetail, DesignSystemFileDetail, DesignSystemFileSummary, DesignSystemGenerationJob, DesignSystemPackageAudit, DesignSystemPackageAuditIssue, DesignSystemProvenance, DesignSystemRevision, DesignSystemRevisionJobRequest, DesignSystemRevisionStatus, DesignSystemSummary, DesignSystemTokenContractRebuildDecision, DesignSystemTokenContractRebuildJobRequest, DesignSystemTokenContractRebuildJobResponse, LiveArtifact, LiveArtifactDetailResponse, LiveArtifactListResponse, LiveArtifactPreview, LiveArtifactRefreshLogEntry, LiveArtifactRefreshStatus, LiveArtifactStatus, LiveArtifactSummary, MediaAspect, OrbitRunSummary, OrbitStatusResponse, ProjectDeploymentsResponse, ProviderTestRequest, PersistedAgentEvent, ProviderModelOption, ProviderModelsKind, ProviderModelsRequest, ProviderModelsResponse, Project, ProjectLocationPrefs, ProjectPlatform, ProjectBrowserWorkspaceTab, ProjectTabsState, PreviewCommentMember, PreviewAnnotationStyle, PreviewCommentSelectionKind, PreviewComment, PreviewCommentAnchorState, PreviewCommentAttachment, PreviewCommentStatus, PreviewCommentTarget, PreviewCommentUpsertRequest, PreviewVisualMarkKind, ProjectDisplayStatus, ProjectFile, ProjectFolder, ProjectFileKind, ProjectKind, ProjectMetadata, ProjectTemplate, RenameProjectFileResponse, CodexPetSummary, CodexPetsResponse, SyncCommunityPetsRequest, SyncCommunityPetsResponse, SkillDetail, SkillSummary, InstallInput, InstallSkillRequest, InstallSkillResponse, InstallDesignSystemResponse, UninstallResponse, UpdateDeployConfigRequest } from '@open-design/contracts';
