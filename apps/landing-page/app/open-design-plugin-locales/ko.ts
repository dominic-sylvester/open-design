...
const ko: OpenDesignPluginCopy = {
  ...
  demo: {
    ...
    lead:
      '먼저 Codex와 OpenDesign의 전체 작업 공간을 살펴본 뒤, 실제 설치부터 결과물 완성까지의 과정을 따라가세요.',
    overviewAlt:
      'OpenDesign 플러그인을 사용한 실제 Codex 작업과 완성된 Goodfield 카페 웹사이트',
    overviewLabel: '실제 Codex 작업',
    overviewCaption:
      '프롬프트, OpenDesign으로의 작업 전달, 생성된 파일, 완성된 웹사이트를 하나의 작업 공간에서 모두 확인할 수 있습니다.',
    ...
    steps: [
      {
        ...
        body:
          'Codex가 설치를 마치면 새 작업에서 설치된 OpenDesign 플러그인을 열고 “Try now”를 선택해 시작하세요.',
        alt: 'Try now 버튼이 보이는 실제 Codex의 OpenDesign 플러그인 상세 화면',
      },
      {
        phase: '제작',
        title: '디자인 브리프를 작성하세요',
        body:
          'OpenDesign을 멘션한 뒤 만들 결과물과 콘텐츠, 시각적 방향, 반응형 요구사항을 설명하세요.',
        alt: 'OpenDesign에 따뜻한 분위기의 동네 카페 웹사이트 제작을 요청하는 실제 Codex 프롬프트',
      },
      {
        phase: '제작',
        title: '실시간 작업 전달 과정을 확인하세요',
        body:
          'Codex가 방향을 확인하고 프로젝트를 만든 뒤 OpenDesign에 작업을 넘기면 파일이 실시간으로 나타납니다.',
        alt: '동네 카페 웹사이트를 생성하고 있는 실제 Codex 및 OpenDesign 작업 공간',
      },
      {
        phase: '제작',
        title: '완성된 결과를 검토하세요',
        ...
        alt: 'Codex의 OpenDesign 플러그인으로 완성한 Goodfield 동네 카페 랜딩 페이지',
      },
    ],
  },
  use: {
    ...
    lead:
      'Codex의 플러그인 메뉴에서 OpenDesign을 선택하고 결과물을 설명한 뒤 같은 작업에서 계속 다듬으세요. Codex는 플러그인 멘션을 OpenDesign 칩으로 표시합니다.',
    promptLabel: '실제 Codex 작업에서 사용한 프롬프트',
    copyPrompt: 'Codex 프롬프트 복사',
    galleryAria: 'OpenDesign으로 만든 사례',
    templates: [
      {
      ...
      {
        alt: '타이포그래피 지도를 활용한 OpenDesign Osaka 이벤트 랜딩 페이지',
        label: '이벤트 페이지',
      },
      {
      ...
      {
        alt: '밝은 캔버스 위에 구성한 OpenDesign 모델 타임라인 인터페이스',
        label: '인터랙티브 스토리',
      },
    ],
  ...
  faq: {
    title: '설치 전에 확인할 내용',
    lead: '작업 제어는 Codex가 맡고, 시각적 제작 과정은 OpenDesign이 처리합니다.',
    items: [
      {
        q: '이 플러그인을 설치하면 Codex에 무엇이 추가되나요?',
        a:
          '웹사이트, 슬라이드, 프로토타입, 디자인 시스템을 위한 OpenDesign 워크플로가 Codex에 추가됩니다. 플러그인은 브리프, 프로젝트, 결과물 생성을 위해 로컬 OpenDesign MCP에 연결됩니다.',
      },
      {
      ...
      },
      {
        q: '설치 전에 무엇이 필요한가요?',
        a:
          'Codex CLI 0.144.6 이상과 OpenDesign 0.17.0 이상이 필요합니다. 로컬 MCP를 등록하기 전에 OpenDesign을 설치하세요.',
      },
      {
      ...
      },
      {
        ...
        a:
          '아니요. 등록된 로컬 MCP는 필요할 때 서명된 OpenDesign 런타임을 헤드리스 모드로 시작할 수 있습니다.',
      },
    ],
  },
  final: {
